...
function editCoiff(e) {
  ...
  var html = '<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><meta charset="UTF-8">'
    ...
    + '<div class="jours">'
    + '<button type="button" class="j" id="jLun" onclick="tJ(this,'Lun')">Lun</button>'
    + '<button type="button" class="j" id="jMar" onclick="tJ(this,'Mar')">Mar</button>'
    + '<button type="button" class="j" id="jMer" onclick="tJ(this,'Mer')">Mer</button>'
    + '<button type="button" class="j" id="jJeu" onclick="tJ(this,'Jeu')">Jeu</button>'
    + '<button type="button" class="j" id="jVen" onclick="tJ(this,'Ven')">Ven</button>'
    + '<button type="button" class="j" id="jSam" onclick="tJ(this,'Sam')">Sam</button>'
    + '<button type="button" class="j" id="jDim" onclick="tJ(this,'Dim')">Dim</button>'
    + '</div></div>'
